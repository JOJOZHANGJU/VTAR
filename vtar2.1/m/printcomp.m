...
% $Date: 2002/03/28 13:26:27 $ $Revision: 1.16 $  
...
case 'prev',       % Preview was selected
    ...
    % xinhui added , 04-17/2004
    try  
        orient landscape
        set(VT.handles.vtar,'PaperPositionMode','auto') ;
        printpreview(VT.handles.vtar) ;
        set(VT.handles.vtar,'PaperPositionMode','manual') ;
    catch
        errordlg('Error in print preview', 'Error', 'modal') ;
    end
...
case 'prnt',       % Print was selected; don't show preview
    ...
    try  
        ...
        set(VT.handles.vtar,'PaperPositionMode','auto') ;
        if ispc
%            printdlg('-setup',VT.handles.vtar) ;
            printdlg(VT.handles.vtar) ;
        else
            printdlg('-crossplatform',VT.handles.vtar) ;
        end
        set(VT.handles.vtar,'PaperPositionMode','manual') ;
    catch
        errordlg('Error in print ', 'Error', 'modal') ;
    end
