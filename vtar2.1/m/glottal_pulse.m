function varargout = glottal_pulse(varargin)
% GLOTTAL_PULSE M-file for glottal_pulse.fig
%      GLOTTAL_PULSE, by itself, creates a new GLOTTAL_PULSE or raises the existing
%      singleton*.
%
%      H = GLOTTAL_PULSE returns the handle to a new GLOTTAL_PULSE or the handle to
%      the existing singleton*.
%
%      GLOTTAL_PULSE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GLOTTAL_PULSE.M with the given input arguments.
%
%      GLOTTAL_PULSE('Property','Value',...) creates a new GLOTTAL_PULSE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before glottal_pulse_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to glottal_pulse_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help glottal_pulse
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @glottal_pulse_OpeningFcn, ...
                   'gui_OutputFcn',  @glottal_pulse_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before glottal_pulse is made visible.
function glottal_pulse_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to glottal_pulse (see VARARGIN)

% Choose default command line output for glottal_pulse
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes glottal_pulse wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = glottal_pulse_OutputFcn(hObject, eventdata, handles)
