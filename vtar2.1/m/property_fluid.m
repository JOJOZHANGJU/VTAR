% function varargout = property_fluid(varargin)
% 
...
%
function varargout = property_fluid(varargin)
% PROPERTY_FLUID Application M-file for property_fluid.fig
%    FIG = PROPERTY_FLUID launch property_fluid GUI.
%    PROPERTY_FLUID('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.5 06-Apr-2004 18:05:12
...
%| property_fluid in the inspector. By default, GUIDE sets the property_fluid to:
...
set(handles.density, 'String', VT.PropertyDefault{i}.RHO);
...
if isnan( str2double( get(handles.density, 'String') ))  | 0 > ( str2double( get(handles.density, 'String') ))
...
% 
% if 0 > ( str2double( get(handles.density, 'String') ))
%     errordlg('density must be a positive number','error', 'modal'); return ;
% end
...
VT.Property.RHO = str2double( get(handles.density, 'String') ) ;
...
global VT
global Current_Fluid ; 
set(handles.density, 'String', VT.Property.RHO );
