...
%function get_acousticResponse(Category, Type)
function vtar_artitrary(Tubes, rad, mode)
...
%        [f, AR] = arbitray_model(Fupper, df, deltaL, ORAL_MODE, Tubes, VT.Property) ;
        [f, AR] = arbitray_model(Fupper, df, deltaL, mode, Tubes, VT.Property) ;
